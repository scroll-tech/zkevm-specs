...
def test_sstore(
    ...
    tables = Tables(
        ...
        rw_table=set(
            [
                (1, RW.Read, RWTableTag.CallContext, 1, CallContextFieldTag.TxId, tx.id, 0, 0, 0, 0),
                (
                    2,
                    RW.Read,
                ...
                (4, RW.Read, RWTableTag.Stack, 1, 1022, storage_slot, 0, 0, 0, 0),
                (5, RW.Read, RWTableTag.Stack, 1, 1023, value, 0, 0, 0, 0),
                (
                    6,
                    RW.Read,
